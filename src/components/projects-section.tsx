        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-2">
            {technologies.map((tech, index) => (
              <span 
                key={index}
                className="px-3 py-1 bg-gradient-to-r from-blue-100 to-teal-100 text-blue-800 rounded-full text-sm font-medium"
              >
                {tech}
              </span>
            ))}
...
export function ProjectsSection() {
  ...
  const projects = [
    {
      ...
      metrics: [
        ...
        "Serves 50K+ monthly active users",
    ...
    },
    {
      ...
      metrics: [
        "Monitors 100+ application metrics",
    ...
    },
    {
      ...
      metrics: [
        "Increased content engagement by 60%",
        "Automated 80% of SEO tasks",
        "Serves 200+ enterprise clients"
      ],
      github: "#",
      demo: "#"
    }
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">Featured Projects</h2>
