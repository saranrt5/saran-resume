    ...
    duration: 0.6
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        delay: 0.4
          ...
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-slate-800 mb-4"><span className="editable-text">Technical Tools & Proficiency</span></h4>
            ...
            }} className="px-3 py-2 bg-slate-100 text-slate-700 rounded-lg text-sm font-medium text-center">
                  {tool}
                </motion.div>)}
            </div>
          </div>
