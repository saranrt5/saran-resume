...
function MetricCard({ icon, value, label, suffix = "", prefix = "", delay = 0 }: MetricCardProps) {
...
export function MetricsSection() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">Key Metrics</h2>
