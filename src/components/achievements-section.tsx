...
export function AchievementsSection() {
  ...
  const achievements = [
    {
      ...
      details: [
        ...
        "Featured in company's annual innovation showcase"
      ]
    },
    {
      ...
      details: [
        "Achieved 150% of quarterly goals",
        "Reduced system downtime by 60%",
        "Mentored 3 junior developers to promotion",
        "Implemented monitoring system saving $200K annually"
      ]
    },
    {
      ...
      details: [
        "Competed against 500+ developers worldwide",
        "Built AI tool improving web accessibility",
        "Generated 50K+ users in first month",
        "Open-sourced project with 2K+ GitHub stars"
      ]
    }
  ];
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">Achievements & Awards</h2>
