      ...
      <div className="p-6">
        ...
        duration: 0.3
          ...
          <div className="space-y-4 pt-4 border-t border-slate-200">
            ...
            <div>
              <h4 className="font-semibold text-slate-800 mb-2"><span className="editable-text">Technologies:</span></h4>
...
export function ExperienceSection() {
  ...
  return <motion.div ref={ref} initial={{
    ...
    duration: 0.6
      ...
      <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center"><span className="editable-text">Work Experience</span></h2>
